...
__DEFINE__(1664288816263, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1664288816264,"./event-store":1664288816265}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664288816264, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1664288816265, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1664288816264,"./utils":1664288816266}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664288816266, function(require, module, exports) {
...
return __REQUIRE__(1664288816263);
})()
