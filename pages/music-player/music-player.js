...
Page({
  ...
  onLoad(options) {
    ...
    playerStore.onStates(this.data.stateKeys, this.getPlaySongInfosHandler)
  },

  updateProgress: throttle(function(currentTime) {
    if (this.data.isSliderChanging) return
    // 1.记录当前歌曲的播放时间 2.修改sliderValue
  ...
  onUnload() {
    ...
    playerStore.offStates(this.data.stateKeys, this.getPlaySongInfosHandler)
  }
})